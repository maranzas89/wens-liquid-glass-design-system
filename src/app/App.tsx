  ...
  return (
    ...
    <div className="min-h-screen relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute top-0 left-1/4 w-48 h-48 md:w-96 md:h-96 bg-[color-mix(in_srgb,var(--brand-secondary)_30%,transparent)] rounded-full blur-xl md:blur-3xl animate-pulse" />
        <div className="absolute bottom-0 right-1/4 w-48 h-48 md:w-96 md:h-96 bg-[color-mix(in_srgb,var(--brand-primary)_30%,transparent)] rounded-full blur-xl md:blur-3xl animate-pulse delay-1000" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 md:w-96 md:h-96 bg-[color-mix(in_srgb,var(--brand-accent)_20%,transparent)] rounded-full blur-xl md:blur-3xl animate-pulse delay-500" />
      </div>
      ...
      <div className={`
        ...
        ml-0 ${isNavCollapsed ? 'md:ml-20' : 'md:ml-80'}
      `}>
        <div className="max-w-7xl mx-auto space-y-24">
          {/* Home Section */}
          <section id="home" className="min-h-[60vh] md:min-h-screen flex items-center justify-center">
            <div className="w-full space-y-12">
              ...
              <div className="text-center space-y-6">
                ...
                <h1 className="text-3xl md:text-7xl text-white font-bold bg-gradient-to-r from-[var(--brand-primary)] via-[var(--brand-secondary)] to-[var(--status-error)] bg-clip-text text-transparent">
                  Wen's Project Liquid Glass
                </h1>
                <p className="text-base md:text-2xl text-white/70 max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                ...
                ">
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-white text-3xl md:text-5xl font-bold group-hover:scale-110 transition-transform">60+</p>
                ...
                ">
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-white text-3xl md:text-5xl font-bold group-hover:scale-110 transition-transform">24</p>
                ...
                ">
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-white text-3xl md:text-5xl font-bold group-hover:scale-110 transition-transform">150+</p>
